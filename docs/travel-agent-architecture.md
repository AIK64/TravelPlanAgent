...
> 本节保留最初设计的阶段视角。自 v0.4.0 起，具体版本边界、顺序和验收门禁以 [v0.6 → v1.2 迭代路线](roadmap-to-v1.2.md) 为准：v1.0 完成核心 Agent，v1.1 增加 Preference Memory，v1.2 完成 MCP、备用 Provider、完整前端和生产化部署。
